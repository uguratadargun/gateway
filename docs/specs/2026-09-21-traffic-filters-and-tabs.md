...
Decisions: docs/decisions/0030-a-traffic-row-names-the-run-it-came-from.md
...
- **`docs/decisions/0030-a-traffic-row-names-the-run-it-came-from.md`** — a
...
- modify `docs/design/gateway-pipeline.md`, `docs/design/dashboard.md`,
  `CHANGELOG.md`
- create `docs/decisions/0030-a-traffic-row-names-the-run-it-came-from.md`,
...
in `plugins/gate/reference/docs.md`. `0030` is the next free number — `0029`
is the highest that exists. The design docs are the present tense of the
feature: never "what changed".
...
`Documents: docs/decisions/0030-a-traffic-row-names-the-run-it-came-from.md, docs/design/gateway-pipeline.md, docs/design/dashboard.md`.
...
fixed; every section of `0030` is filled with logic rather than code; the spec
